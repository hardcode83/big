...
3. WHEN un workflow migra, THE SYSTEM SHALL preservar sus `permissions`, `timeout-minutes`, `env` y `concurrency` exactos a nivel de job (solo cambia el `runs-on`).
