...
export type ReservationMutationErrorKey =
  `reservations:mutation.errors.${"create" | "edit" | "cancel" | "confirm"}.${"session" | "forbidden" | "notFound" | "conflict" | "validation" | "server" | "network"}`;

export type ReservationMutationOperation =
  | "create"
  | "edit"
  | "cancel"
  | "confirm";
