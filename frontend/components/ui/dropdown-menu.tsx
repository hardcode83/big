...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-32 overflow-hidden rounded-md border bg-surface text-foreground shadow-lg",
        className,
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-32 overflow-hidden rounded-md border bg-surface text-foreground shadow-md",
          className,
        )}
        {...props}
      />
