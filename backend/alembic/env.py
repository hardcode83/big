...
# database_url is resolved at runtime from env vars (Settings), not the
# static alembic.ini value — Docker Compose fixes it to the `postgres`
# hostname, host runs fall back to `localhost` (see design.md D12/D14).
