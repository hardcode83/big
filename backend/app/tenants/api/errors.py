...
_MAPPING: tuple[tuple[type[TenantDomainError], int, ErrorCode], ...] = (
    (TenantNotFoundError, 404, ErrorCode.NOT_FOUND),
    (TenantValidationError, 422, ErrorCode.VALIDATION_ERROR),
)


def http_error_for(exc: TenantDomainError) -> tuple[int, ErrorCode]:
