...
filter (design D16) from `Base.registry.mappers`, so any model module not yet
imported was simply absent from the net. The filter looked complete in the test
process, where conftest imports everything, and silently covered fewer tables in the
running app. (This docstring used to say the scan "memoises the result on first
use". It did once; the memoisation was removed precisely because it froze the list —
see the docstring of `tenant_scoped_classes` — and this text was left behind.)
...
import app.audit.infrastructure.models  # noqa: F401
...
import app.integrations.infrastructure.models  # noqa: F401
...
import app.pricing.infrastructure.models  # noqa: F401
import app.properties.infrastructure.models  # noqa: F401
import app.reservations.infrastructure.models  # noqa: F401
import app.reviews.infrastructure.models  # noqa: F401
import app.statements.infrastructure.models  # noqa: F401
