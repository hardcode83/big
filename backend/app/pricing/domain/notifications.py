"""The notification a price recommendation produces (R4, design D4/D10).
...
`sdd/steering/security.md`, whose contract for `notification_logs.subject`/`body` was fixed by
`celery-jobs`. This module does not derive a new contract; it complies with the one that
