...
CADENCES: dict[str, timedelta] = {
    ...
    # `guest-scheduled-comms` (R2, design D1/D2) — a declared divergence: PRD §8.3 names no
    # checkout-reminder job at all. Same fifteen-minute cadence and same reasoning as
