...
Integration rather than unit, because what is under test is what a fake cannot show: that the
row a guest's report produces is one the classification flow cannot tell apart from any other
in `OPEN` — which is a statement about the **DDL's** defaults, not about the entity's.
"""
