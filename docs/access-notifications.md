...
envía el código de acceso enmascarado (`****XX`) bajo la excepción 1 (ownership en la tabla
de `sdd/steering/security.md`). Vale la pena tenerlo a mano al mirar una bandeja
