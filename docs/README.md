...
- **`diagrams/`** — diagramas del sistema (C4, hexagonal, ER, state machine, secuencias), nombrados `{YYYY-MM-DD}_{slug}.png`. Se regeneran con `/sdd-toolkit:diagram` cuando un change los deja obsoletos.
